...
import { ArrowLeft, FileText, Mail, Zap } from "lucide-react";
      ...
      <main className="container mx-auto px-4 pb-16 max-w-4xl">
        <div className="space-y-6">
          ...
          <Card className="p-8 glass-card border-2 hover:border-accent/30 transition-all">
            ...
            <div className="mt-4">
              <a 
                href="mailto:legal@spotlightevents.online" 
              ...
              >
                ...
                <span className="text-lg font-bold text-primary">legal@spotlightevents.online</span>
              </a>
            </div>
