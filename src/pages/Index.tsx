          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-4">
                ...
                <span className="text-sm font-medium text-primary">Se hur det fungerar</span>
              </div>
              <h2 className="text-4xl sm:text-5xl font-bold mb-4">
                Från event till kampanj på <span className="text-primary">60 sekunder</span>
              </h2>
              <p className="text-xl text-muted-foreground">
                Se hur Spotlight automatiskt skapar professionella kampanjer
              </p>
            </div>
            
            {/* Video Container */}
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border-2 border-primary/20 bg-card">
              <div className="aspect-video bg-gradient-to-br from-primary/10 via-background to-primary/5 flex items-center justify-center relative group">
                {/* Play button overlay */}
                <div className="absolute inset-0 bg-gradient-to-t from-background/90 via-background/40 to-transparent flex items-center justify-center transition-all duration-300 group-hover:bg-background/70">
                  <button className="w-20 h-20 rounded-full bg-primary hover:bg-primary/90 flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-lg hover:shadow-xl group-hover:scale-125">
                ...
                <div className="absolute inset-0 p-8 flex flex-col justify-between pointer-events-none">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="px-3 py-1.5 rounded-lg bg-background/80 backdrop-blur-sm text-sm font-medium">
                      1:30
                    </div>
                  </div>
                  
                  <div className="space-y-2">
                    <div className="px-4 py-2 rounded-lg bg-background/80 backdrop-blur-sm inline-block">
                      <p className="text-sm font-medium">AI-genererad kampanjtext på sekunder</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 bg-card border-t">
                <div className="flex flex-wrap items-center justify-between gap-4">
                  <div>
                    <h3 className="font-semibold text-lg mb-1">Spotlight Platform Demo</h3>
                    <p className="text-sm text-muted-foreground">Upptäck hur enkelt det är att skapa kampanjer</p>
                  </div>
            ...
            <div className="text-center mt-8">
              <p className="text-muted-foreground mb-4">Redo att komma igång?</p>
              <Link to="/auth">
