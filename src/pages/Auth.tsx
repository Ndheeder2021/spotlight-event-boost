...
export default function Auth() {
  ...
  return (
    <div className={`auth-diagonal-layout min-h-screen relative ${isLogin ? 'login-active' : ''}`}>
        ...
        <div className="grid lg:grid-cols-2 gap-8 w-full max-w-6xl mx-auto">
          ...
          <div className={`flex flex-col justify-center ${isLogin ? 'order-1' : 'order-2'}`}>
            {isLogin ? (
              ...
              <div className="bg-background rounded-3xl p-8 lg:p-12 shadow-2xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="relative">
                    ...
                    {showPassword ? (
                      <EyeOff 
                        className="auth-eye-icon h-5 w-5" 
